...
module.exports.config = {
  insteon({ isProdBuild, latestBuild }) {
    return {
      entry: {
        entrypoint: path.resolve(paths.insteon_dir, "src/entrypoint.ts"),
      },
      outputPath: outputPath(paths.insteon_output_root, latestBuild),
      publicPath: publicPath(latestBuild, paths.insteon_publicPath),
      isProdBuild,
      latestBuild,
      isHassioBuild: true,
    };
