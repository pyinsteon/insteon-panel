...
gulp.task("gen-index-insteon-dev", async () => {
  writeInsteonEntrypoint(
    `${paths.insteon_publicPath}/frontend_latest/entrypoint-dev.js`,
    `${paths.insteon_publicPath}/frontend_es5/entrypoint-dev.js`
  );
});
